create_project finn_vivado_stitch_proj /tmp/finn_dev_root/vivado_stitch_proj_hpzv0ql8 -part xc7z020clg400-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_0_trvgljc1 /tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_0_fef91rdc/project_MVAU_hls_0/sol1/impl/ip /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_1_3g4djbp5 /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_y8l34yow /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_2_z3qh77hh /tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_1_hgvfpfm0/project_MVAU_hls_1/sol1/impl/ip /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_3_tqgvq27k /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_4jgpcuzn /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_4_3iyj997w /tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_2_5q7iwcon/project_MVAU_hls_2/sol1/impl/ip /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_5_elwhshod /tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_3_vsxoyhu4/project_MVAU_hls_3/sol1/impl/ip /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_6_sd74noxu] [current_project]
update_ip_catalog
create_bd_design "finn_design"
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_0_trvgljc1/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_0_trvgljc1/StreamingFIFO_rtl_0.v
...
set_property -dict [list CONFIG.DEPTH {60} CONFIG.WIDTH {1280} CONFIG.INIT_FILE {/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_0_fef91rdc/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_0/MVAU_hls_0_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_1_3g4djbp5/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_1_3g4djbp5/StreamingFIFO_rtl_1.v
create_bd_cell -type module -reference StreamingFIFO_rtl_1 StreamingFIFO_rtl_1
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_y8l34yow/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_y8l34yow/dwc.sv
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_y8l34yow/StreamingDataWidthConverter_rtl_0.v
create_bd_cell -type module -reference StreamingDataWidthConverter_rtl_0 StreamingDataWidthConverter_rtl_0
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_2_z3qh77hh/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_2_z3qh77hh/StreamingFIFO_rtl_2.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_1_hgvfpfm0/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_1/MVAU_hls_1_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_3_tqgvq27k/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_3_tqgvq27k/StreamingFIFO_rtl_3.v
create_bd_cell -type module -reference StreamingFIFO_rtl_3 StreamingFIFO_rtl_3
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_4jgpcuzn/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_4jgpcuzn/dwc.sv
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_4jgpcuzn/StreamingDataWidthConverter_rtl_1.v
create_bd_cell -type module -reference StreamingDataWidthConverter_rtl_1 StreamingDataWidthConverter_rtl_1
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_4_3iyj997w/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_4_3iyj997w/StreamingFIFO_rtl_4.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_2_5q7iwcon/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_2/MVAU_hls_2_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_5_elwhshod/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_5_elwhshod/StreamingFIFO_rtl_5.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_3_vsxoyhu4/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_3/MVAU_hls_3_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_6_sd74noxu/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_6_sd74noxu/StreamingFIFO_rtl_6.v
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_root/vivado_stitch_proj_hpzv0ql8/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_root/vivado_stitch_proj_hpzv0ql8/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_root/vivado_stitch_proj_hpzv0ql8/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_root/vivado_stitch_proj_hpzv0ql8/all_verilog_srcs.txt w]
