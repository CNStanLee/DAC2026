create_project finn_vivado_stitch_proj /tmp/finn_dev_root/vivado_stitch_proj_hxa7iyde -part xc7z020clg400-1
set_msg_config -id {[BD 41-1753]} -suppress
set_property ip_repo_paths [list $::env(FINN_ROOT)/finn-rtllib/memstream /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_0_b5u79hx1 /tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_0_muju16go/project_MVAU_hls_0/sol1/impl/ip /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_1_m2n1kvad /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_q9_9i6pi /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_2_r27knnax /tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_1_ewx_7tes/project_MVAU_hls_1/sol1/impl/ip /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_3_nui4k9_f /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_0dty9xmi /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_4_u1e5uqii /tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_2_rke1n8kf/project_MVAU_hls_2/sol1/impl/ip /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_5_vw_tx775 /tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_3_j2ucu27q/project_MVAU_hls_3/sol1/impl/ip /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_6_j1rfqk8j] [current_project]
update_ip_catalog
create_bd_design "finn_design"
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_0_b5u79hx1/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_0_b5u79hx1/StreamingFIFO_rtl_0.v
...
set_property -dict [list CONFIG.DEPTH {60} CONFIG.WIDTH {1280} CONFIG.INIT_FILE {/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_0_muju16go/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_0/MVAU_hls_0_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_1_m2n1kvad/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_1_m2n1kvad/StreamingFIFO_rtl_1.v
create_bd_cell -type module -reference StreamingFIFO_rtl_1 StreamingFIFO_rtl_1
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_q9_9i6pi/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_q9_9i6pi/dwc.sv
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_0_q9_9i6pi/StreamingDataWidthConverter_rtl_0.v
create_bd_cell -type module -reference StreamingDataWidthConverter_rtl_0 StreamingDataWidthConverter_rtl_0
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_2_r27knnax/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_2_r27knnax/StreamingFIFO_rtl_2.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_1_ewx_7tes/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_1/MVAU_hls_1_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_3_nui4k9_f/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_3_nui4k9_f/StreamingFIFO_rtl_3.v
create_bd_cell -type module -reference StreamingFIFO_rtl_3 StreamingFIFO_rtl_3
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_0dty9xmi/dwc_axi.sv
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_0dty9xmi/dwc.sv
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingDataWidthConverter_rtl_1_0dty9xmi/StreamingDataWidthConverter_rtl_1.v
create_bd_cell -type module -reference StreamingDataWidthConverter_rtl_1 StreamingDataWidthConverter_rtl_1
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_4_u1e5uqii/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_4_u1e5uqii/StreamingFIFO_rtl_4.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {128} CONFIG.INIT_FILE {/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_2_rke1n8kf/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_2/MVAU_hls_2_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_5_vw_tx775/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_5_vw_tx775/StreamingFIFO_rtl_5.v
...
set_property -dict [list CONFIG.DEPTH {64} CONFIG.WIDTH {8} CONFIG.INIT_FILE {/tmp/finn_dev_root/code_gen_ipgen_MVAU_hls_3_j2ucu27q/memblock.dat} CONFIG.RAM_STYLE {auto} ] [get_bd_cells /MVAU_hls_3/MVAU_hls_3_wstrm]
...
save_bd_design
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_6_j1rfqk8j/Q_srl.v
add_files -norecurse /tmp/finn_dev_root/code_gen_ipgen_StreamingFIFO_rtl_6_j1rfqk8j/StreamingFIFO_rtl_6.v
...
validate_bd_design
save_bd_design
make_wrapper -files [get_files /tmp/finn_dev_root/vivado_stitch_proj_hxa7iyde/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/finn_design.bd] -top
add_files -norecurse /tmp/finn_dev_root/vivado_stitch_proj_hxa7iyde/finn_vivado_stitch_proj.srcs/sources_1/bd/finn_design/hdl/finn_design_wrapper.v
set_property top finn_design_wrapper [current_fileset]
ipx::package_project -root_dir /tmp/finn_dev_root/vivado_stitch_proj_hxa7iyde/ip -vendor xilinx_finn -library finn -taxonomy /UserIP -module finn_design -import_files
...
set fp [open /tmp/finn_dev_root/vivado_stitch_proj_hxa7iyde/all_verilog_srcs.txt w]
