...
open_project -reset mvau_sfcsr_prj

add_files sfcsr_mvau_stream_top.cpp -cflags "-std=c++14 -I$::env(FINN_HLS_ROOT) -I$::env(FINN_HLS_ROOT)/tb"
...
add_files -tb sfcsr_mvau_stream_tb.cpp -cflags "-std=c++14 -I$::env(FINN_HLS_ROOT) -I$::env(FINN_HLS_ROOT)/tb"
# 
...
set_top Testbench_mvau_sfcsr_stream
