...
HLS_SOURCES = ../../../../tcsr_mvau_stream_tb.cpp ../../../../mvau_stream_top_masked.cpp ../../../../mvau_stream_top.cpp ../../../../tcsr_mvau_stream_top.cpp
...
$(ObjDir)/tcsr_mvau_stream_tb.o: ../../../../tcsr_mvau_stream_tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../tcsr_mvau_stream_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
-include $(ObjDir)/tcsr_mvau_stream_tb.d
...
$(ObjDir)/tcsr_mvau_stream_top.o: ../../../../tcsr_mvau_stream_top.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../tcsr_mvau_stream_top.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -I/home/changhong/prj/finn_cli_fork/scripts/DAC2026/spmm/finn_hlslib -I/home/changhong/prj/finn_cli_fork/scripts/DAC2026/spmm/finn_hlslib/tb -std=c++14  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/tcsr_mvau_stream_top.d
